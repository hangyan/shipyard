...
import (
	...
	"github.com/hangyan/docker/pkg/stdcopy"
	"github.com/hangyan/shipyard"
	"github.com/hangyan/shipyard/controller/manager"
	"github.com/hangyan/shipyard/controller/middleware/access"
	"github.com/hangyan/shipyard/controller/middleware/auth"
...
func destroy(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
	container, err := controllerManager.Container(id, true)
	if err != nil {
...
func stopContainer(w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
	id := vars["id"]
	container, err := controllerManager.Container(id, false)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func containers(w http.ResponseWriter, r *http.Request) {
	...
	containers := controllerManager.Containers(isAll)
...
func inspectContainer(w http.ResponseWriter, r *http.Request) {
	...
	container, err := controllerManager.Container(id, isAll)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func addEngine(w http.ResponseWriter, r *http.Request) {
	...
	// TODO : remove memory and cpu info
